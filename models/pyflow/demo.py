...
parser.add_argument(
    ...
    help='Visualize (i.e. save) output of flow.',default=True)
...
print(flow.shape)
np.save('examples/testFlow.npy', flow)
...
if args.viz:
    ...
    cv2.imwrite('examples/testFlow_new.png', rgb)
    print(1)
    cv2.imwrite('examples/004Warped_new.jpg', im2W[:, :, ::-1] * 255)
